...
public class Service {
    ...
    public Service(int maDichVu, String tenDichVu, int dienTich, double chiPhiThue, int soNguoiToiDa, int maKieuThue, int maLoaiDichVu, String tieuChuanPhong, String tienNghiKhac, String dienTichHoBoi, int soTang) {
    ...
    public Service(String tenDichVu, int dienTich, double chiPhiThue, int soNguoiToiDa, int maKieuThue, int maLoaiDichVu, String tieuChuanPhong, String tienNghiKhac, String dienTichHoBoi, int soTang) {
        this.tenDichVu = tenDichVu;
        this.dienTich = dienTich;
        this.chiPhiThue = chiPhiThue;
        this.soNguoiToiDa = soNguoiToiDa;
